...
public class ModMenuIntegration implements ModMenuApi {
    ...
    private static Screen buildScreen(Screen parent) {
        ...
        risky.addEntry(
            eb.startIntSlider(
                    Component.translatable("config.autocrop.option.missedReplantRetryCooldownTicks"),
                    cfg.missedReplantRetryCooldownTicks, 1, 200
                )
                .setDefaultValue(20)
                .setTooltip(Component.translatable("config.autocrop.option.missedReplantRetryCooldownTicks.tooltip"))
                .setSaveConsumer(v -> cfg.missedReplantRetryCooldownTicks = v)
                .build()
        );
